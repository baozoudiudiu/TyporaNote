...
2. 在`_MyHomePageState.build`方法中的`Column`的子widget中添加一个按钮（`TextButton`） :
   ...
   ![图2-2](https://book.flutterchina.club/assets/img/2-2.de6feb35.png) ![图2-3](https://book.flutterchina.club/assets/img/2-3.c20b3236.png)
...
![图2-4](https://book.flutterchina.club/assets/img/2-4.1abb1cab.png)
